          ...
          <div className="col-lg-4 hidden-md-down">
            <div className="topmenu text-center">
              <ul className="list-inline">
                <li className="list-inline-item"><a href="/"><i className="fa fa-star"></i> Trends</a></li>
                <li className="list-inline-item"><a href="/"><i className="fa fa-bolt"></i> Hot Topics</a></li>
                <li className="list-inline-item"><a href="/"><i className="fa fa-user-circle-o"></i> Write for us</a></li>
              </ul>
            </div>
          </div>
